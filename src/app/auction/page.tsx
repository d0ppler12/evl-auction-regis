...
export default function AuctionPage() {
        ...
        (payload) => {
          ...
          setAllPlayers((currentPlayers) => {
            if (ns.current_player_id) {
              const pl = currentPlayers.find(
                (p) => p.id === ns.current_player_id,
              );
              if (pl)
                setCurrentPlayer((prevCP: any) =>
                  prevCP?.id === pl.id ? prevCP : pl,
                );
            } else {
  ...
  useEffect(() => {
    ...
    if (auctionState.current_player_id !== prev?.current_player_id) {
      ...
      setBidHistory((h) => {
        const newBid = {
          amount: auctionState.current_bid,
          teamId: auctionState.current_bid_team_id,
        };
  ...
  return (
    <div
      className="min-h-screen md:h-screen bg-[#0a0e1a] text-white overflow-x-hidden md:overflow-hidden flex flex-col font-sans relative"
      style={{
        backgroundImage: "linear-gradient(135deg, #0a0e1a 0%, #000000 100%)",
      }}
    >
      ...
      <header className="z-20 w-full px-4 md:px-8 pt-4 pb-2 flex flex-row items-center justify-between relative shrink-0">
        ...
        <div className="flex-1 flex justify-start items-center">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-[#000] border-2 border-[#00d4ff] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(0,212,255,0.5)] z-30 overflow-hidden shrink-0">
            <img
              src="/evl-hero.png"
              alt="EVL"
              className="w-[120%] h-[120%] object-contain filter drop-shadow-[0_0_5px_rgba(0,212,255,0.8)]"
            />
          </div>
        </div>
        ...
        <div className="flex-none flex justify-center px-2 md:px-4">
          <h1
            className="text-3xl md:text-5xl font-black uppercase tracking-widest text-[#00d4ff] drop-shadow-[0_0_15px_rgba(0,212,255,0.6)] leading-tight text-center whitespace-nowrap"
        ...
        <div className="flex-1 flex justify-end items-center">
          {auctionState?.is_active ? (
            <div className="flex items-center gap-3 bg-red-500/10 border border-red-500/30 px-5 py-2 rounded-full shadow-[0_0_15px_rgba(239,68,68,0.2)]">
              ...
              <span className="text-red-500 font-black text-sm uppercase tracking-[0.2em]">
                LIVE <span className="opacity-70 ml-1">00:24</span>
              </span>
            </div>
          ) : (
            <div className="flex items-center gap-3 bg-gray-500/10 border border-gray-500/30 px-5 py-2 rounded-full">
              <span className="text-gray-400 font-black text-sm uppercase tracking-[0.2em]">
                PAUSED
              </span>
            </div>
          )}
          ...
          {currentPlayer && !isPlayerDone ? (
            ...
            >
              ...
              <div className="flex flex-col gap-4 relative w-full lg:max-w-md ml-auto">
                ...
                <div
                  className="absolute -left-2 top-0 bottom-0 w-1 rounded-full shadow-[0_0_10px_#00d4ff] z-10"
                  style={{
                    backgroundColor: biddingTeam
                      ? biddingTeam.color_theme || "#00d4ff"
                      : "#00d4ff",
                  }}
                />
                ...
                <div className="bg-[#11111a]/80 border border-[#00d4ff]/30 p-6 rounded-xl backdrop-blur-md relative overflow-hidden shadow-[0_0_15px_rgba(0,212,255,0.1)]">
                  ...
                  <h1
                    className="text-3xl lg:text-5xl font-black text-white uppercase mb-4 leading-tight"
                    style={{
                      fontFamily: "Impact, sans-serif",
                      textShadow:
                        "0 0 15px rgba(0,212,255,0.6), 0 0 5px rgba(0,212,255,0.3)",
                ...
                <div className="bg-[#11111a]/80 border border-[#00d4ff]/30 p-6 rounded-xl backdrop-blur-md shadow-[0_0_15px_rgba(0,212,255,0.1)] h-fit">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed whitespace-pre-wrap">
                    {currentPlayer.volleyball_experience ||
                      currentPlayer.previous_tournament_experience ||
                      "No prior tournament experience listed."}
                  </p>
                </div>
              </div>
              {/* CENTER COLUMN - PHOTO */}
              <div className="flex flex-col items-center justify-start gap-3 w-full max-w-[350px] shrink-0 mx-auto">
                ...
                <div className="relative flex justify-center">
                  <div
                    className="w-[320px] h-[368px] lg:w-[350px] lg:h-[402px] bg-[#00d4ff] p-1.5 shadow-[0_0_40px_rgba(0,212,255,0.4)] transition-all duration-300"
                    style={{
                      clipPath:
                  ...
                  >
                    <div
                      className="w-full h-full bg-[#0a0e1a] overflow-hidden flex items-center justify-center relative"
                      style={{
                        clipPath:
                          "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)",
                      }}
                    >
                      ...
                      currentPlayer.photo_url !== "placeholder" ? (
                        <img
                        ...
                        <div className="text-[#00d4ff]/20 text-7xl font-black">
                          EVL
                        </div>
                      )}
                    </div>
              ...
              <div className="flex flex-col gap-4 w-full lg:max-w-md mr-auto">
                ...
                <div className="bg-[#11111a]/80 border border-[#00d4ff]/30 p-5 rounded-xl backdrop-blur-md flex justify-between items-center shadow-[0_0_15px_rgba(0,212,255,0.1)]">
                  ...
                  <span className="text-white font-mono font-black text-2xl">
                    ₹ {currentPlayer.base_price?.toLocaleString() || "0"}
                  </span>
                </div>
                ...
                <div className="bg-[#11111a]/90 border-2 border-[#00d4ff] p-6 lg:p-8 rounded-xl backdrop-blur-md shadow-[0_0_30px_rgba(0,212,255,0.2)] flex flex-col items-center">
                  <p className="text-[#00d4ff] text-sm font-black uppercase tracking-[0.4em] mb-2">
                    Current Bid
                  </p>
                  <motion.div
                  ...
                  <div className="w-full bg-[#0a0e1a]/80 rounded-xl p-5 flex flex-col items-center border border-white/10 relative overflow-hidden">
                    ...
                    {biddingTeam ? (
                      <div className="flex flex-col items-center w-full z-10">
                        ...
                        <p
                          className="text-3xl font-black text-white uppercase tracking-wider text-center drop-shadow-md"
                          style={{ color: biddingTeam.color_theme || "#fff" }}
                        >
                          {biddingTeam.name}
                        </p>
                        ...
                        <div className="flex justify-between items-center w-full px-2">
                          ...
                          <span className="text-[#f5c518] font-mono font-black text-xl">
                            ₹{" "}
                            {(
                              biddingTeam.purse_remaining -
                      ...
                      <div className="flex flex-col items-center py-8 z-10">
                        ...
                        <p className="text-sm font-black text-[#00d4ff]/70 uppercase tracking-widest">
                          AWAITING BID...
                        </p>
                      </div>
                    )}
                ...
                <div className="w-full bg-[#11111a]/60 border border-white/10 rounded-xl p-5 backdrop-blur-sm shadow-[0_0_15px_rgba(0,212,255,0.05)]">
                  <p className="text-gray-400 text-[10px] font-black uppercase tracking-[0.2em] border-b border-white/10 pb-2 mb-3">
                    Recent Bids
                  </p>
                  <div className="flex flex-col gap-2 overflow-hidden h-[90px]">
                    {bidHistory.length > 0 ? (
                      bidHistory
                        .filter(
                          (bid, idx, arr) =>
                            idx === 0 || bid.teamId !== arr[idx - 1].teamId,
                        )
                        .slice(0, 3)
                        .map((bid, idx) => {
                          ...
                          return (
                            <div
                              key={idx}
                              className="flex justify-between items-center text-sm animate-fade-in-up opacity-80"
                            >
              ...
              >
                ...
                {biddingTeam && (
                  <div
                    ...
                    style={
                      {
                        borderColor: biddingTeam.color_theme || "#f5c518",
                        "--team-color": biddingTeam.color_theme || "#f5c518",
                      } as any
                    }
                  >
                    ...
                    {biddingTeam.logo_url && (
                      <img
                        src={biddingTeam.logo_url}
                        className="h-16 object-contain z-10 drop-shadow-lg"
                        alt=""
                      />
                    )}
                    <span className="text-5xl font-black text-white uppercase tracking-wider z-10 drop-shadow-md">
                      {biddingTeam.name}
                    </span>
                  </div>
                )}
      ...
      <div className="w-full bg-[#11111a] border-t border-[#00d4ff]/30 py-4 px-6 flex flex-col md:flex-row justify-center items-center gap-4 md:gap-10 z-10 shrink-0 shadow-[0_-10px_30px_rgba(0,0,0,0.4)]">
        <span className="text-xs md:text-sm text-gray-400 font-bold uppercase tracking-[0.3em] mb-2 md:mb-0">
          Sponsored by:
        </span>
        ...
        <div className="flex items-center gap-8 md:gap-16 bg-white/5 px-8 py-3 rounded-full border border-white/10 shadow-inner">
          <img
            src="/wendys_logo.png"
            alt="Wendy's"
            className="h-[40px] md:h-[95px] w-auto object-contain"
          />
          <div className="h-8 w-px bg-white/20" />
          <img
            src="/enser_logo.png"
            alt="Enser"
            className="h-[35px] md:h-[95px] w-auto object-contain"
          />
          <div className="h-8 w-px bg-white/20" />
          <img
            src="/namhra_logo.png"
      ...
      <footer className="z-20 h-10 bg-black border-t-2 border-[#00d4ff] flex items-center overflow-hidden shrink-0 sticky bottom-0 w-full shadow-[0_-5px_20px_rgba(0,212,255,0.15)]">
        ...
        <div className="flex animate-marquee whitespace-nowrap items-center h-full">
          {teams.length === 0 ? (
            <span className="px-8 text-gray-600 text-xs uppercase font-bold tracking-widest">
              No teams loaded
            </span>
          ) : (
            [...teams, ...teams, ...teams, ...teams, ...teams].map(
              (team, idx) => {
                const isLeading = biddingTeam?.id === team.id;
                const displayedPurse = isLeading
                  ? team.purse_remaining - (auctionState?.current_bid || 0)
                  : team.purse_remaining;

                return (
                  <div
                    key={`${team.id}-${idx}`}
                    className="flex items-center px-8 border-r border-white/10"
                  >
                    {team.logo_url && (
                      <img
                        src={team.logo_url}
                    ...
                    <span
                      className={`text-sm font-bold uppercase tracking-widest mr-4 ${idx % 2 === 0 ? "text-[#00d4ff]" : "text-gray-300"}`}
                    >
                      {team.name}
                    </span>
                    <span className="text-[10px] text-gray-500 mr-2 uppercase tracking-widest">
                      Purse
                    </span>
                    <span
                      className={`font-mono font-black text-sm ${isLeading ? "text-[#f5c518]" : "text-white"}`}
                    >
