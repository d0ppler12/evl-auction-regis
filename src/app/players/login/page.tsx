        ...
        <div className="relative z-20 flex flex-col h-full justify-center max-w-xl">
          ...
          >
            ...
            <p className="text-base lg:text-lg text-slate-300 font-medium mb-8 max-w-sm">
              Your EVL journey starts here. Track your profile, auction
              standing, and tournament activity in one place.
            </p>
          </motion.div>
        </div>
      </div>
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="mb-6 border-b border-white/10 pb-5">
                ...
                <p className="text-xs text-slate-400">
                  Enter your credentials to access your athlete workspace.
                </p>
              </div>
                ...
                {isApprovedError && (
                  ...
                  >
                    ...
                    <div className="text-xs leading-relaxed">
                      ...
                      Account not approved yet. Please wait for the tournament
                      administrators to verify your payment and registration.
                    </div>
                  </motion.div>
                )}
              ...
              <div className="text-center pt-4 border-t border-white/5 flex flex-col gap-2 text-xs">
                ...
                <Link
                  href="/"
                  className="text-slate-500 hover:text-slate-300 transition-colors font-semibold mt-2"
                >
                  ← Back to Home
                </Link>
              </div>
