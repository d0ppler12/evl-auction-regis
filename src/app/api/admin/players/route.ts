...
const PLAYER_FIELDS = [
  ...
  'jersey_number', 'utr_number', 'volleyball_experience',
...
export async function GET(request: Request) {
  try {
    ...
    let query = supabaseAdmin
      .from('players')
      .select('id, full_name, age, jersey_number, jersey_name, jersey_size, base_price, status, auction_status, team_id, sold_price, created_at, teams(name)')
